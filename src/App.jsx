      ...
      <nav className={`fixed top-0 left-0 right-0 z-[100] flex items-center justify-between px-6 py-4 md:py-5 md:px-12 transition-all duration-300 ${isMobileMenuOpen ? 'bg-transparent border-b-transparent shadow-none' : 'backdrop-blur-md bg-[#121212]/80 border-b border-white/5 shadow-xl'}`}>
        ...
        <div className="hidden md:flex items-center gap-8 text-sm font-medium tracking-wide">
          ...
          <div className="flex items-center gap-6 border-l border-white/20 pl-8 ml-2">
            ...
            <a href="#menu" className="px-6 py-2.5 bg-[#ce9d4f] text-[#121212] font-bold rounded-full hover:bg-white transition-colors duration-300">
              ORDER NOW
            </a>
          </div>
        </div>
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          ...
          >
            ...
            <a href="#menu" onClick={() => setIsMobileMenuOpen(false)} className="px-8 py-4 mt-6 bg-[#ce9d4f] text-[#121212] font-bold rounded-full hover:bg-white transition-colors duration-300 shadow-[0_0_20px_rgba(206,157,79,0.3)]">
              ORDER NOW
            </a>
